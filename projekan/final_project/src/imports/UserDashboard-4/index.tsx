import svgPaths from "./svg-hgucwgjwh7";
...
function Frame13() {
  return (
    <div className="absolute bg-white content-stretch flex h-[38px] items-center justify-center left-[238px] px-[48px] py-[10px] rounded-[15px] top-0 w-[146px]">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#252271] text-[15px] whitespace-nowrap">Edit</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <a className="absolute bg-[#252271] block cursor-pointer h-[38px] left-[389px] rounded-[15px] top-0 w-[146px]">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[73px] not-italic text-[15px] text-center text-white top-[10px] w-[66px]">Kembali</p>
    </a>
  );
}
...
function Button5() {
  return (
    <div className="col-1 h-[63px] justify-self-stretch overflow-clip relative row-7 self-end shrink-0" data-name="button">
      <Frame13 />
      <Frame10 />
    </div>
  );
