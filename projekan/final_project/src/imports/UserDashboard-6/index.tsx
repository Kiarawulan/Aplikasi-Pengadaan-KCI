import svgPaths from "./svg-tca82edmgc";
...
function Frame1() {
  return (
    <div className="col-1 content-stretch flex flex-col items-start justify-self-stretch relative row-3 self-start shrink-0">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[24px] text-black text-center w-full">Delete User</p>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="col-1 cursor-pointer h-[53px] justify-self-stretch overflow-clip relative row-5 self-end shrink-0" data-name="button">
      <Frame7 />
      <Frame4 />
    </div>
  );
...
function PopUpAddPengadaanBaru() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white gap-x-[16px] gap-y-[9px] grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[_____63px_130px_29px_34px_68px] h-[373px] left-[calc(50%+0.5px)] overflow-clip px-[28px] rounded-[15px] top-[calc(50%+45.5px)] w-[591px]" data-name="POP UP ADD PENGADAAN BARU">
      ...
      <Frame1 />
      <Button5 />
      <p className="[word-break:break-word] col-1 font-['Inter:Regular',sans-serif] font-normal justify-self-stretch leading-[normal] not-italic relative row-4 self-start shrink-0 text-[14px] text-black text-center">Kamu akan menghapus user secara permanen?</p>
    </div>
  );
}
