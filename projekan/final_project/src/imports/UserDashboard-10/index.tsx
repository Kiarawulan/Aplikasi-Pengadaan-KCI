import svgPaths from "./svg-7ufmdiyijp";
...
function Button4() {
  return (
    <div className="bg-white relative rounded-[10px] shrink-0" data-name="Button">
...
function Button5() {
  return (
    <div className="bg-gradient-to-r from-[#252271] relative rounded-[10px] shrink-0 to-[#3a37a0]" data-name="Button">
...
function Container43() {
  return (
    <div className="h-[18.75px] relative shrink-0 w-[65.94px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] left-0 not-italic text-[12.5px] text-white top-[8.5px] w-[66.103px]">
...
function LinkDashboardActive() {
  return (
    <div className="content-stretch drop-shadow-[0px_1px_2px_rgba(0,0,0,0.25)] flex gap-[10px] items-center px-[10px] py-[8px] relative rounded-[8px] shrink-0 w-[224px]" data-name="Link - Dashboard (Active)">
      <Svg />
      <Container43 />
    </div>
  );
