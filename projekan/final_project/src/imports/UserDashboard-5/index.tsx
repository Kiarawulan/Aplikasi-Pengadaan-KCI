import svgPaths from "./svg-79ss2tldjk";
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex h-[27px] items-start left-[499px] overflow-clip pb-[10px] pl-[4px] pr-[10px] pt-[4px] top-[5px] w-[24px]">
      <Svg8 />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="h-[32px] relative rounded-[15px] shrink-0 w-full">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Frame16 />
      </div>
      <div aria-hidden className="absolute border border-[#d3d3d3] border-solid inset-0 pointer-events-none rounded-[15px]" />
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[4px] items-start justify-self-stretch relative row-5 self-stretch shrink-0">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(82,82,82,0.6)] w-full">{`Email `}</p>
      <Frame />
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[35px] left-[32px] overflow-clip top-[6px] w-[356px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[39px] justify-center leading-[0] left-0 not-italic text-[15px] text-white top-[19.5px] w-[216px]">
        <p className="leading-[normal]">Detail User</p>
      </div>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex h-[27px] items-start left-[500px] overflow-clip pb-[10px] pl-[4px] pr-[10px] pt-[4px] top-[5px] w-[24px]">
      <Svg9 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="h-[37px] relative rounded-[15px] shrink-0 w-full">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Frame17 />
      </div>
      <div aria-hidden className="absolute border border-[#d3d3d3] border-solid inset-0 pointer-events-none rounded-[15px]" />
...
function Frame7() {
  return (
    <div className="col-1 content-stretch flex flex-col items-start justify-self-stretch relative row-6 self-start shrink-0">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(82,82,82,0.6)] w-full">Departemen</p>
      <Frame2 />
    </div>
  );
}
...
function Frame13() {
  return (
    <a className="absolute bg-white content-stretch flex h-[38px] items-center justify-center left-[238px] px-[48px] py-[10px] rounded-[15px] top-0 w-[146px]">
      <div aria-hidden className="absolute border border-[#252271] border-solid inset-0 pointer-events-none rounded-[15px]" />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#252271] text-[15px] text-left whitespace-nowrap">Cancel</p>
    </a>
  );
}
...
function Frame10() {
  return (
    <a className="absolute bg-[#252271] block h-[38px] left-[389px] rounded-[15px] top-0 w-[146px]">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[73px] not-italic text-[15px] text-center text-white top-[10px] w-[66px]">Simpan</p>
    </a>
  );
}
...
function Button5() {
  return (
    <div className="col-1 cursor-pointer h-[63px] justify-self-stretch overflow-clip relative row-7 self-end shrink-0" data-name="button">
      <Frame13 />
      <Frame10 />
    </div>
  );
...
function Frame14() {
  return (
    <div className="col-1 h-[158px] justify-self-center relative row-2 self-start shrink-0 w-[151px]">
      <svg className="absolute block inset-0 size-full" fill="none" height="158" preserveAspectRatio="none" viewBox="0 0 151 158" width="151">
        <g id="Frame 82">
          <g id="Ellipse 6">
            <circle cx="76" cy="79" fill="var(--fill-0, #D9D9D9)" r="75" />
            <circle cx="76" cy="79" r="73.5" stroke="var(--stroke-0, #252271)" strokeOpacity="0.33" strokeWidth="3" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex h-[25px] items-start left-[226px] overflow-clip pb-[10px] pl-[4px] pr-[10px] pt-[4px] top-[4px] w-[24px]">
      <Svg10 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="h-[33px] relative rounded-[15px] shrink-0 w-full">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Frame18 />
      </div>
      <div aria-hidden className="absolute border border-[#d3d3d3] border-solid inset-0 pointer-events-none rounded-[15px]" />
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[52px] items-start justify-self-start relative self-start shrink-0 w-[257px]">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(82,82,82,0.6)] w-full">Nama User</p>
      <Frame1 />
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex h-[27px] items-start left-[230px] overflow-clip pb-[10px] pl-[4px] pr-[10px] pt-[4px] top-[6px] w-[24px]">
      <Svg11 />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col items-start justify-self-stretch relative self-stretch shrink-0">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(82,82,82,0.6)] w-full">Role</p>
      <Frame4 />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="col-1 gap-x-[10px] gap-y-[10px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(1,fit-content(100%))] overflow-clip relative row-4 self-start shrink-0 w-[534px]">
      <Frame3 />
      <Frame6 />
    </div>
  );
...
function PopUpAddPengadaanBaru() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white gap-x-[16px] gap-y-[9px] grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[_______63px_165px_25px_58px_51px_51px_83px] h-[556px] left-[calc(50%+0.5px)] overflow-clip px-[28px] rounded-[15px] top-[calc(50%-19px)] w-[591px]" data-name="POP UP ADD PENGADAAN BARU">
      <Frame5 />
      <Frame11 />
      <Frame7 />
      <Button5 />
