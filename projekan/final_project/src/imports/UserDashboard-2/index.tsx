import svgPaths from "./svg-2d0e6a2d6t";
...
function Requestion() {
  return (
    <div className="absolute grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[__55px_minmax(0,1fr)] h-[780px] left-[249px] overflow-clip px-[20px] py-[69px] top-0 w-[1191px]" data-name="Requestion">
      <p className="[word-break:break-word] font-['Inter:Extra_Bold',sans-serif] font-extrabold justify-self-stretch leading-[normal] not-italic relative self-stretch shrink-0 text-[#252271] text-[36px]">Manajemen User</p>
      <FilterTableCard />
    </div>
  );
}
