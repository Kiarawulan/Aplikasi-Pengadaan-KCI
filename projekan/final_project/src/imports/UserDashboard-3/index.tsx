import svgPaths from "./svg-gt1693xw8v";
...
function Requestion() {
  return (
    <div className="absolute grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[__55px_minmax(0,1fr)] h-[780px] left-[249px] overflow-clip px-[20px] py-[69px] top-0 w-[1191px]" data-name="Requestion">
      <p className="[word-break:break-word] font-['Inter:Extra_Bold',sans-serif] font-extrabold justify-self-stretch leading-[normal] not-italic relative self-stretch shrink-0 text-[36px] text-black">Manajemen User</p>
      <FilterTableCard />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="col-[1/span_2] content-stretch flex flex-col gap-[4px] h-[58px] items-start justify-self-stretch relative row-3 self-start shrink-0">
...
function Frame3() {
  return (
    <div className="col-[1/span_2] content-stretch flex flex-col gap-[4px] items-start justify-self-stretch relative row-2 self-stretch shrink-0">
  ...
  return (
    <div className="absolute h-[35px] left-[32px] overflow-clip top-[6px] w-[356px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[39px] justify-center leading-[0] left-0 not-italic text-[15px] text-white top-[19.5px] w-[216px]">
        <p className="leading-[normal]">Tambah User</p>
      </div>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="bg-[#252271] col-[1/span_2] h-[48px] justify-self-center overflow-clip relative row-1 self-start shrink-0 w-[683px]">
      <Frame8 />
    </div>
  );
}
...
function Frame6() {
  return (
    <a className="absolute bg-[#252271] block cursor-pointer h-[38px] left-[481px] rounded-[15px] top-[4px] w-[146px]">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[73px] not-italic text-[15px] text-center text-white top-[10px] w-[66px]">Buat</p>
    </a>
  );
}
...
function Button5() {
  return (
    <div className="col-[1/span_2] h-[51px] justify-self-stretch overflow-clip relative row-5 self-center shrink-0" data-name="button">
      <a className="absolute bg-white block border border-[#252271] border-solid cursor-pointer h-[38px] left-[330px] right-[151px] rounded-[15px] top-[4px]" />
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[378px] not-italic text-[#252271] text-[15px] top-[14px] whitespace-nowrap">Cancel</p>
      <Frame6 />
    </div>
  );
}
...
function PopUpAddPengadaanBaru() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white gap-x-[16px] gap-y-[9px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[_____65px_58px_58px_58px_78px] h-[354px] left-[calc(50%-0.5px)] overflow-clip px-[28px] rounded-[15px] top-1/2 w-[683px]" data-name="POP UP ADD PENGADAAN BARU">
      <Frame2 />
      <Frame3 />
      <Frame7 />
      <Button5 />
