...
if (code.includes(oldPbjStepFields)) {
  code = code.replace(oldPbjStepFields, newPbjStepFields);
  console.log('Replaced PBJ step fields');
} else {
  console.log('PBJ step fields pattern not matched directly, checking...');
}

// Replace Contract step rendering
